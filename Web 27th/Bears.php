<html>
  ...
  <body>
    ...
    <section id="welcome">
      <div class="container">
        <h2> The official Chicago Bears Roster </h2>
      </div>
    </section>
...
while($row = mysqli_fetch_assoc($result)) {
      ...
      echo '<div class="item"><a href="PlayerDetailsCHI.php?'.$row['Name'].'">'. $row['Name'] .'</a></div>';
  }
  echo '</div>';
}
mysqli_close($cxn);
