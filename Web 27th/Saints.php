<html>
  ...
  <body>
    ...
    <section id="welcome">
      <div class="container">
        <h2> The official New Orleans Saints Roster </h2>
      </div>
    </section>
...
while($row = mysqli_fetch_assoc($result)) {
      ...
      echo '<div class="item"><a href="PlayerDetailsNO.php?'.$row['Name'].'">'. $row['Name'] .'</a></div>';
  }
  echo '</div>';
}
