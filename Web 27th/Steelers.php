<html>
  ...
  <body>
    ...
    <section id="welcome">
      <div class="container">
        <h2> The official Pittsburgh Steelers Roster </h2>
      </div>
    </section>
...
while($row = mysqli_fetch_assoc($result)) {
      ...
      echo '<div class="item"><a href="PlayerDetailsPIT.php?'.$row['Name'].'">'. $row['Name'] .'</a></div>';
  }
  echo '</div>';
}
