<html>
  ...
  <body>
    ...
    <section id="showcaseCheifs">
      <div class="container">
        <h1> Kansas City Cheifs </h1>
      </div>
    </section>

    <section id="welcome">
      <div class="container">
        <h2> The official Kansas City Cheifs Roster </h2>
      </div>
    </section>
...
while($row = mysqli_fetch_assoc($result)) {
      ...
      echo '<div class="item"><a href="PlayerDetailsKC.php?'.$row['Name'].'">'. $row['Name'] .'</a></div>';
  }
  echo '</div>';
}
