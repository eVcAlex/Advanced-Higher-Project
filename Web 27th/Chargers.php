<html>
  ...
  <body>
    ...
    <section id="welcome">
      <div class="container">
        <h2> The official Los Angeles Chargers Roster </h2>
      </div>
    </section>
...
while($row = mysqli_fetch_assoc($result)) {
      ...
      echo '<div class="item"><a href="PlayerDetailsLAC.php?'.$row['Name'].'">'. $row['Name'] .'</a></div>';
  }
  echo '</div>';
}
